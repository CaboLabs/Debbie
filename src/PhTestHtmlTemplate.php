...
class PhTestHtmlTemplate {
  ...
  public function Html_template($total_suites, $total_cases, $failed_cases, $successful_case, $html_report, $test_time, $total_tests, $total_successful, $total_failed, $total_asserts, $item3, $item4)
  {
    global $content;
                  ...
                  <div id="content">
                      ...
                      <div class="container-fluid">
                          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-1 pb-2">
                              <h1 class="h2 text-gray-800">Tests reports</h1>
                              ...
                              <div class="col-xl-12 col-lg-12">
                                  <div class="card shadow mb-4">
                                      ...
                                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                          <h6 class="m-0 font-weight-bold text-primary">Total Summary</h6>
